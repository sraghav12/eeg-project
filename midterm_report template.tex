...
\title{Formatting Instructions For 11-785}
...
\section{Submission of papers to 11-785}

11-785 requires electronic submissions.  The electronic submission site is
\begin{center}
  \url{https://canvas.cmu.edu/courses/12995/assignments/230445}
\end{center}
...
Papers to be submitted to 11-785 must be prepared according to the
...
various formatting requirements your 11-785 paper must satisfy.

The only supported style file for 11-785 is \verb+neurips_2019.sty+,
...
\item The IEEE has recommendations for generating PDF files whose fonts are also
  acceptable for 11-785. Please see
